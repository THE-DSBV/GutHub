...
('Ham and Cheese Sandwich', 'ham, cheese, gluten freebread', 'Assemble sandwich.', TRUE, FALSE, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSC3eq_tbNOvbyI9iS0dD0OIUZ2qmd_WAJjKg&s'),
('Shrimp Tacos', 'shrimp, corn tortillas, cabbage', 'Cook shrimp and assemble tacos.', TRUE, FALSE, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQykYMqZ7df6sSThFogh71oMfwMJ-PoWUpjFQ&s'),
('Rice and Beans', 'rice, beans, spices', 'Cook rice and beans together.', TRUE, FALSE, 'https://mealsbymavis.com/wp-content/uploads/2022/01/rice-and-peas_6_revised-500x500.jpg'),
...
('Vegetable Fried Rice', 'rice, vegetables, soy sauce', 'Stir fry rice with vegetables.', TRUE, FALSE, 'https://www.budgetbytes.com/wp-content/uploads/2022/03/Vegetable-Fried-Rice-plate-500x500.jpg'),
...
('Egg Fried Rice', 'rice, eggs, soy sauce', 'Stir fry rice and eggs.', TRUE, FALSE, 'https://www.indianhealthyrecipes.com/wp-content/uploads/2021/07/egg-fried-rice-recipe-500x500.jpg'),
...
('Egg Salad', 'eggs, mayo, mustard', 'Mix chopped eggs and dressing.', TRUE, FALSE, 'https://i2.wp.com/www.downshiftology.com/wp-content/uploads/2023/03/Egg-Salad-main.jpg'),
...
('Chicken Rice Bowl', 'chicken, rice, vegetables', 'Cook chicken and assemble bowl.', TRUE, FALSE, 'https://www.tasteofhome.com/wp-content/uploads/2018/01/Chicken-Rice-Bowl_EXPS_TOHAM25_25774_P2_MD_04_24_10b.jpg)');
...
('bob_brown', 10, 'Best chicken and waffles in town!', 6, '2026-03-22'),
('jane_smith', 8, 'Loved the patio seating.', 7, '2026-03-20'),
('duncan_volk', 9, 'Delicious Asian fusion dishes.', 7, '2026-03-21'),
('john_doe', 7, 'Good but not outstanding.', 8, '2026-03-20'),
('alice_johnson', 10, 'Incredible BBQ flavors!', 8, '2026-03-21'),
('bob_brown', 9, 'Great ribs and brisket.', 8, '2026-03-22'),
('jane_smith', 8, 'Nice variety of Thai dishes.', 9, '2026-03-20'),
('duncan_volk', 10, 'Authentic and delicious.', 9, '2026-03-21'),
('john_doe', 8, 'Fresh and flavorful.', 10, '2026-03-20'),
('alice_johnson', 10, 'One of my favorite salad places!', 10, '2026-03-21'),
...
('john_doe', 2, 'Not great.', 4, '2026-03-21'),
...
('duncan_volk', 1, 'Worst thing ever', 7, '2026-03-22'),
...
('bob_brown', 8, 'Good but a bit heavy.', 12, '2026-03-22'),
('jane_smith', 9, 'Great flavors and textures.', 13, '2026-03-23'),
('alice_johnson', 9, 'Very satisfying.', 14, '2026-03-24'),
('bob_brown', 8, 'Nice quick meal.', 14, '2026-03-25'),
('duncan_volk', 9, 'Great flavors.', 15, '2026-03-24'),
('john_doe', 8, 'Really tasty.', 15, '2026-03-25'),
('jane_smith', 9, 'Hearty and warm.', 16, '2026-03-24'),
('alice_johnson', 8, 'Good comfort food.', 16, '2026-03-25'),
('bob_brown', 8, 'Simple and good.', 17, '2026-03-24'),
('duncan_volk', 7, 'Quick and easy.', 17, '2026-03-25'),
('john_doe', 9, 'Fresh and light.', 18, '2026-03-24'),
('jane_smith', 8, 'Perfect lunch.', 18, '2026-03-25'),
('alice_johnson', 8, 'Very cheesy.', 19, '2026-03-24'),
('bob_brown', 7, 'A bit heavy.', 19, '2026-03-25'),
('duncan_volk', 9, 'Loved the crust.', 20, '2026-03-24'),
('john_doe', 8, 'Great pizza.', 20, '2026-03-25'),
('jane_smith', 9, 'Amazing sauce.', 21, '2026-03-24'),
('alice_johnson', 8, 'Really flavorful.', 21, '2026-03-25'),
('bob_brown', 8, 'Juicy burger.', 22, '2026-03-24'),
('duncan_volk', 7, 'Classic taste.', 22, '2026-03-25'),
('john_doe', 9, 'Creamy and rich.', 23, '2026-03-24'),
('jane_smith', 8, 'Very filling.', 23, '2026-03-25'),
('alice_johnson', 9, 'Great peppers.', 24, '2026-03-24'),
('bob_brown', 8, 'Nice balance.', 24, '2026-03-25'),
('duncan_volk', 8, 'Good breakfast.', 25, '2026-03-24'),
('john_doe', 7, 'Pretty filling.', 25, '2026-03-25'),
('jane_smith', 8, 'Classic soup.', 26, '2026-03-24'),
('alice_johnson', 7, 'Warm and nice.', 26, '2026-03-25'),
('bob_brown', 9, 'Perfect steak.', 27, '2026-03-24'),
('duncan_volk', 8, 'Cooked well.', 27, '2026-03-25'),
('john_doe', 9, 'Great curry.', 28, '2026-03-24'),
('jane_smith', 8, 'Nice spice.', 28, '2026-03-25'),
('alice_johnson', 7, 'Simple sandwich.', 29, '2026-03-24'),
('bob_brown', 8, 'Quick meal.', 29, '2026-03-25'),
('duncan_volk', 9, 'Loved shrimp.', 30, '2026-03-24'),
('john_doe', 8, 'Great tacos.', 30, '2026-03-25'),
('jane_smith', 8, 'Hearty dish.', 31, '2026-03-24'),
('alice_johnson', 7, 'Simple but good.', 31, '2026-03-25'),
('bob_brown', 8, 'Comfort meal.', 32, '2026-03-24'),
('duncan_volk', 7, 'Tasty overall.', 32, '2026-03-25'),
('john_doe', 9, 'Fresh flavors.', 33, '2026-03-24'),
('jane_smith', 8, 'Very healthy.', 33, '2026-03-25'),
('alice_johnson', 7, 'Good texture.', 34, '2026-03-24'),
('bob_brown', 8, 'Nice rice dish.', 34, '2026-03-25'),
('duncan_volk', 9, 'Juicy chicken.', 35, '2026-03-24'),
('john_doe', 8, 'Great seasoning.', 35, '2026-03-25'),
('jane_smith', 7, 'Basic but good.', 36, '2026-03-24'),
('alice_johnson', 8, 'Nice and simple.', 36, '2026-03-25'),
('bob_brown', 8, 'Light pasta.', 37, '2026-03-24'),
('duncan_volk', 7, 'Good texture.', 37, '2026-03-25'),
('john_doe', 9, 'Great veggie bowl.', 38, '2026-03-24'),
('jane_smith', 8, 'Healthy and tasty.', 38, '2026-03-25'),
('alice_johnson', 8, 'Nice quesadilla.', 39, '2026-03-24'),
('bob_brown', 4, 'Alright', 39, '2026-03-25'),
('duncan_volk', 9, 'Loved the soup.', 40, '2026-03-24'),
('john_doe', 8, 'Great flavor.', 40, '2026-03-25');
...
('Brownie Batter Gelato', 'Allergen-free brownie batter flavoured gelato', TRUE, 15),
('Salted Caramel Gelato', 'Creamy salted caramel gelato made without gluten or dairy', TRUE, 15),
('Boozy Espresso Gelato', 'Espresso gelato with a splash of Kahlua', TRUE, 15),

('Guacamole and Chips', 'Fresh guacamole with crispy corn tortilla chips', FALSE, 16),
('Enchiladas', 'Corn tortilla enchiladas with chicken, salsa, and cheese', FALSE, 16),
('Fish Tacos', 'Grilled fish with homemade salsa and corn tortillas', FALSE, 16),

('Dark Chocolate Mousse', 'Rich gluten-free dark chocolate mousse with raspberry coulis', FALSE, 17),
('Hummus', 'House-made hummus with warm flatbread', FALSE, 17),
('Lamb Ribs', 'Slow-cooked lamb ribs with dukkah and yogurt', FALSE, 17),

('Patatas Bravas', 'Crispy potatoes with spicy tomato sauce and aioli', FALSE, 18),
('Gambas al Ajillo', 'Garlic shrimp sautéed in olive oil with chili', FALSE, 18),
('Iberico Charcuterie', 'Selection of Spanish cured meats and manchego', FALSE, 18),

('Saganaki', 'Pan-seared halloumi flambéed tableside with lemon', FALSE, 19),
('Whole Sea Bass', 'Grilled whole sea bass with lemon, capers, and herbs', FALSE, 19),
('Avgolemono Soup', 'Classic Greek egg and lemon soup with orzo', FALSE, 19);
